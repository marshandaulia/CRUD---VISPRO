...
namespace Database_BeautyTrack
{
    public partial class FormMain : Form
    {
        ...
        private void FormMain_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                dataGridView1.Columns[4].HeaderText = "Instagram";
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                if (txtUsername.Text != "" && txtPassword.Text != "" && txtEmail.Text != "")
                {
                    ...
                    query = string.Format("insert into tbl_pengguna  values ('{0}','{1}','{2}','{3}','{4}');", txtID.Text, txtUsername.Text, txtPassword.Text, txtEmail.Text, txtInstagram.Text);
                ...
                if (txtUsername.Text != "")
                {
                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        foreach (DataRow kolom in ds.Tables[0].Rows)
                        {
                            ...
                            txtInstagram.Text = kolom["instagram"].ToString();
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                if (txtPassword.Text != "" && txtEmail.Text != "" && txtUsername.Text != "" && txtID.Text != "")
                {
                    ...
                    query = string.Format("update tbl_pengguna set password = '{0}', nama_pengguna = '{1}', level = '{2}' where id_pengguna = '{3}'", txtPassword.Text, txtEmail.Text, txtInstagram.Text, txtID.Text);
